...
var mouseDown$ = (0, _rxjs.fromEvent)(canvas, "mousedown");
var mouseMove$ = (0, _rxjs.fromEvent)(canvas, "mousemove");
var mouseUp$ = (0, _rxjs.fromEvent)(canvas, "mouseup");
mouseDown$.pipe((0, _operators.switchMap)(function () {
  return mouseMove$.pipe((0, _operators.map)(function (e) {
    return {
      ctx: e.target.getContext("2d"),
      x: e.offsetX,
      y: e.offsetY
    };
  }), (0, _operators.pairwise)(), (0, _operators.takeUntil)(mouseUp$));
...
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js"}]},{},["paint.js"], null)
