...
var store$ = action$.pipe((0, _operators.startWith)({
  type: "__INIT__"
}), (0, _operators.scan)(_reducer.default, initialState), (0, _operators.shareReplay)(1));
...
(0, _rxjs.fromEvent)(start, "click").subscribe(function () {
  return dispatch({
    type: "INCREMENT"
  });
});
...
},{"rxjs":"../node_modules/rxjs/_esm5/index.js","rxjs/operators":"../node_modules/rxjs/_esm5/operators/index.js","./reducer":"reducer.js"}]},{},["store.js"], null)
